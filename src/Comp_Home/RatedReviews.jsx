import CardOfAllReveiw from "../Comp_Review/CardOfAllReveiw";
...
const RatedReviews = ({ratedReviews}) => {
    ...
    return (
        <div className="w-11/12 md:w-10/12 mx-auto">
            <h2 className="text-center text-2xl md:text-5xl font-bold py-3 md:py-6 border-2 border-x-white border-y-black rounded-lg w-2/3 md:w-1/2 mx-auto mt-5">Highest Rated Games</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10">
                ...
                {ratedReviews?.map(reviews => <CardOfAllReveiw key={reviews._id} reviews={reviews}></CardOfAllReveiw>
                )}
            </div>
        </div>
    );
