...
const Login = () => {
  const { user, setUser, userLogin, googleSignIn } = useContext(AuthContext);
  ...
  return (
    ...
    <div className="bg-gradient-to-br from-blue-600 to-sky-500 ">
      <Helmet>
        ...
        <h2 className="text-center text-3xl font-bold  my-auto py-10">
          {user ? `Logged in with ${user.email}` : "Login with ChillGamer"}
        </h2>
